...
if("TRUE" STREQUAL "TRUE")
  set(crazyflie_demo_SOURCE_PREFIX /home/qingchen/catkin_ws/src/crazyflie_ros/crazyflie_demo)
  set(crazyflie_demo_DEVEL_PREFIX /home/qingchen/catkin_ws/devel)
  ...
  set(crazyflie_demo_INSTALL_PREFIX /home/qingchen/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'crazyflie_demo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'crazyflie_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qingchen/catkin_ws/src/crazyflie_ros/crazyflie_demo/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${crazyflie_demo_dep}_FOUND)
      find_package(${crazyflie_demo_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${crazyflie_demo_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
