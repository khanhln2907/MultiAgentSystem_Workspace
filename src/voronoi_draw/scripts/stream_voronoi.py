...
if __name__ == '__main__':
	...
	vt_3 = rospy.Subscriber('/san/vt_ctr', Vector3, callback_3)
	vt_5 = rospy.Subscriber('/wu/vt_ctr', Vector3, callback_5)
	vt_6 = rospy.Subscriber('/liu/vt_ctr', Vector3, callback_6)
	vt_7 = rospy.Subscriber('/qi/vt_ctr', Vector3, callback_7)
